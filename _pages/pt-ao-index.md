...
<section class="hero">
  <div class="hero-content">
    ...
    <div class="hero-cta">
      <a href="{{ site.baseurl }}/pt/blog" class="button button-primary">{{ i18n.home.cta_blog }}</a>
    </div>
  </div>
</section>

<section class="featured-section disclaimer-callout" aria-label="Aviso legal do site">
  <h2>{{ i18n.home.disclaimer_title }}</h2>
  <p>{{ i18n.home.disclaimer_text }} <a href="{{ site.baseurl }}/pt/aviso/">{{ i18n.home.disclaimer_link }}</a>.</p>
</section>
...
<section class="featured-section">
  ...
  <div class="section-footer">
    <a href="{{ site.baseurl }}/pt/blog" class="button button-secondary">{{ i18n.home.view_all_posts }}</a>
  </div>
</section>
...
<section class="featured-section">
  ...
  <div class="projects-grid">
    {% assign projects = site.showcase | where: "language", "pt" | limit: 3 %}
